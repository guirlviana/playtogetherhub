  ...
  return (
    <div className="inline-block relative">
      ...
      >
        ...
        {isDropDownOpen && (
          <div className="transition-all duration-300 ease-in-out origin-top-right transform absolute right-0 top-full mt-2 w-40 z-10 bg-white rounded-md shadow-lg animate-slide-down">
            <a
              href="/profile"
